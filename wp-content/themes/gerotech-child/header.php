...
<a class="skip-link" href="#main"><?php esc_html_e( 'Skip to content', 'gerotech-child' ); ?></a>
	...
	<header class="site-header" role="banner">
		<div class="site-header__inner">
			...
			<a class="btn-get-quote" href="<?php gerotech_page_link( 'contact' ); ?>"><?php esc_html_e( 'Talk to an Engineer', 'gerotech-child' ); ?></a>
		...
		<nav class="mobile-nav" aria-label="<?php esc_attr_e( 'Mobile navigation', 'gerotech-child' ); ?>">
			...
			<a class="mobile-nav__link" href="<?php gerotech_page_link( 'contact' ); ?>"><?php esc_html_e( 'Talk to an Engineer', 'gerotech-child' ); ?></a>
		</nav>
	</header>
